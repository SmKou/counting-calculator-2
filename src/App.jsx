    ...
    return <>
        ...
        <main>
            <aside>
                ...
                <p>The values of either the count or step can be changed using the number keys. However, if you want to change the step, you will first need to zero it, otherwise you will be appending to the current value rather than replacing.</p>
                <p>Using the keyboard to enter values is not currently supported.</p>
            </aside>
            <CountingCalculator />
        </main>
    </>
